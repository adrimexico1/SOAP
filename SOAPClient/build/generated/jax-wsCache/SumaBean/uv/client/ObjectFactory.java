 ...
 * generated in the uv.client package. 
...
public class ObjectFactory {
    ...
    private final static QName _Suma_QNAME = new QName("http://calc.uv/", "suma");
    private final static QName _SumaResponse_QNAME = new QName("http://calc.uv/", "sumaResponse");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: uv.client
     * 
     */
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://calc.uv/", name = "suma")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://calc.uv/", name = "sumaResponse")
